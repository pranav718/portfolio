...
export const projects: Project[] = [
    {
        id: 'tunneru',
        title: 'tunneru',
        description: 'a lightweight zero-dependency tunneling engine, binary multiplexer, and real-time request inspection suite built in raw go from first principles. features custom 9-byte binary stream framing, interactive bubble tea terminal tui telemetry, and a next.js web dashboard with 1-click webhook replay.',
        ...
        techStack: ['Go', 'Next.js', 'React', 'TypeScript', 'Tailwind', 'Bubbletea', 'WebSockets'],
        status: 'Live',
        githubUrl: 'https://github.com/pranav718/tunneru',
        liveUrl: 'https://tunneru.knightkun.codes',
        postUrl: 'https://x.com/knightkun__/status/2092266377499558009?s=20',
        image: '/images/projects/tunneru.png',
        videoUrl: '/videos/projects/tunneru.mp4',
    },
    {
        id: 'hotaru',
        title: 'hotaru',
